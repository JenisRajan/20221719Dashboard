...
#In this code, I've added a sidebar radio button for navigation between tabs, and based on the selected tab, 
# it displays the respective content. Also, I moved the import statement for `seaborn` to the top of the script to maintain consistency. 
